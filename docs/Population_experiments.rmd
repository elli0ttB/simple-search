...
plot(k16_1000$Score ~ k16_1000$Search_method,xlab="", ylab="Score", las=2)

```

The plot shows that uniform crossover and two-point crossover were better than random mutation. However, the scores in the various problems were so different that it is hard to tell what is happening. 
...
```{r}
pairwise.wilcox.test(data_50_runs$Score, data_50_runs$Search_method, paired = TRUE)
